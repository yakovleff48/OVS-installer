...
4.Для последующего использования данного ПО (создание нового клиента, редактирования клиентского доступа, сброса сессии, блокировки и разблокировки клиента, просмотра журнала подключений, отзыва сертификатов, и других действий управления клиентами и сервером нужно ввести в консоли команду ovs
